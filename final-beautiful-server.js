...
// Serve static assets (hero image)
app.use('/attached_assets', express.static('/var/www/attached_assets'));

// Complete beautiful HTML with hero image and React-style design
...
// All routes serve the beautiful HTML
app.get('*', (req, res) => {
    res.send(beautifulHTML);
});

app.listen(PORT, '0.0.0.0', () => {
    console.log(`🌙 BEAUTIFUL BABY SLEEP WEBSITE RUNNING ON PORT ${PORT}`);
    console.log('✨ Features: Hero Image, Professional Design, Three Services');
    console.log('🎯 Hero Image: /attached_assets/image_1751435091363.jpeg');
});