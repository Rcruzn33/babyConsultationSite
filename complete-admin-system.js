/**
 * Complete Baby Sleep Whisperer Admin System
...
// Sample data matching original Replit system
const sampleData = {
  testimonials: [
    {
      id: 1,
  ...
  blogPosts: [
    ...
    },
    {
      ...
      content: "The environment plays a crucial role in your baby's sleep quality. From lighting and temperature to noise levels and room setup, every detail matters. Learn how to create the optimal sleep sanctuary that promotes better rest for your baby and peace of mind for you.",
      author: "Sleep Consultant",
      published: false,
...
// Main website route - Beautiful professional design
app.get('/', (req, res) => {
  res.send(`
<!DOCTYPE html>
<html lang="en">
...
// Admin Authentication Page - Exact Replit replica
app.get('/admin-auth', (req, res) => {
  res.sendFile(path.join(__dirname, 'admin-auth.html'));
});

// Serve static admin-auth.html file
app.use('/admin-auth.html', express.static(path.join(__dirname, 'admin-auth.html')));

// Admin Dashboard - Complete Replit replica
...
app.listen(PORT, '0.0.0.0', () => {
  ...
  console.log(`✨ Complete system with original Replit styling`);
});