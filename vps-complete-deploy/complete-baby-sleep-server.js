    ...
    <script type="text/babel">
        ...
        function App() {
            ...
            useEffect(() => {
                ...
                setBlogPosts([
                    { id: 1, title: 'Sleep Training Methods: What Works Best', excerpt: 'Explore different sleep training approaches and find the one that fits your family\'s comfort level.', content: 'Sleep training is a journey that requires patience, consistency, and the right approach for your family. There are several methods to choose from, each with their own benefits and considerations...', author: 'Happy Baby Sleeping', createdAt: '2025-01-15', readTime: '5 min read', image: '😴' },
                    { id: 2, title: 'Newborn Sleep Patterns: What to Expect', excerpt: 'Understanding your newborn\'s sleep cycles and establishing healthy habits from day one.', content: 'Newborns sleep differently than older babies and children. Understanding these patterns can help you set realistic expectations and create a foundation for healthy sleep habits...', author: 'Happy Baby Sleeping', createdAt: '2025-01-12', readTime: '7 min read', image: '👶' },
                    { id: 3, title: 'Creating the Perfect Sleep Environment', excerpt: 'Simple changes to your child\'s sleep environment that can make a dramatic difference.', content: 'The sleep environment plays a crucial role in your child\'s ability to fall asleep and stay asleep. From room temperature to lighting, every detail matters...', author: 'Happy Baby Sleeping', createdAt: '2025-01-10', readTime: '4 min read', image: '🌙' }
                ]);
                    ...
                    <section className="py-20 lg:py-32 bg-gradient-to-br from-cream to-white">
                        <div className="max-w-7xl mx-auto px-4">
                            <div className="text-center mb-16">
                                ...
                                <p className="text-xl text-medium-gray max-w-3xl mx-auto">
                                    Real success stories from families who transformed their sleep
                                </p>
                            </div>
                            <div className="grid md:grid-cols-3 gap-8">
                    ...
                    <div className="max-w-7xl mx-auto px-4">
                        ...
                        <div className="grid md:grid-cols-3 gap-8 mb-16">
                            <div className="service-card p-8 rounded-3xl text-center shadow-xl bg-gradient-to-br from-baby-blue/10 to-baby-blue/5 border border-baby-blue/20">
                                ...
                                <button 
                                    onClick={() => selectService('Free Consultation')}
                                    className="w-full bg-baby-blue text-white py-3 rounded-lg hover:bg-baby-blue/90 transition-all duration-300 font-semibold shadow-lg"
                                >
                                    Book Free Call
                                </button>
                            ...
                            <div className="service-card p-8 rounded-3xl text-center shadow-xl relative bg-gradient-to-br from-soft-pink/10 to-soft-pink/5 border border-soft-pink/20">
                                ...
                                <button 
                                    onClick={() => selectService('Complete Sleep Package')}
                                    className="w-full bg-soft-pink text-white py-3 rounded-lg hover:bg-soft-pink/90 transition-all duration-300 font-semibold shadow-lg"
                                >
                                    Start Sleep Training
                                </button>
                            ...
                            <div className="service-card p-8 rounded-3xl text-center shadow-xl bg-gradient-to-br from-mint/10 to-mint/5 border border-mint/20">
                                ...
                                <button 
                                    onClick={() => selectService('Newborn Care')}
                                    className="w-full bg-mint text-white py-3 rounded-lg hover:bg-mint/90 transition-all duration-300 font-semibold shadow-lg"
                                >
                                    Get Newborn Help
                                </button>
                        ...
                        <div id="consultation-form" className="max-w-3xl mx-auto bg-white rounded-3xl shadow-2xl p-8">
                ...
                <div className="py-16">
                    <div className="max-w-7xl mx-auto px-4">
                        ...
                        <div className="grid lg:grid-cols-2 gap-12 mb-16">
                            <div>
                                <img 
                                    src="/attached_assets/IMG_4271_1752258147819.png" 
                                    alt="Sleep consultant professional photo" 
                                    className="professional-photo mx-auto"
                                />
                            </div>
                            <div className="flex flex-col justify-center">
                                ...
                                <p className="text-lg text-medium-gray mb-6 leading-relaxed">
                                    With over 5 years of experience helping families achieve peaceful nights, I understand the challenges that come with sleep deprivation. My gentle, evidence-based approach has helped hundreds of families establish healthy sleep habits.
                                </p>
                                <p className="text-lg text-medium-gray mb-6 leading-relaxed">
                                    Every family is unique, and I believe in creating personalized sleep plans that work with your parenting style and your child's temperament. Together, we'll create a path to better sleep for your entire family.
                                </p>
                                <div className="space-y-4">
                                    <div className="flex items-center">
                                        <span className="text-baby-blue mr-3">✓</span>
                                        <span className="text-medium-gray">Certified Sleep Consultant</span>
                                    </div>
                                    <div className="flex items-center">
                                        <span className="text-baby-blue mr-3">✓</span>
                                        <span className="text-medium-gray">500+ Families Helped</span>
                                    </div>
                                    <div className="flex items-center">
                                        <span className="text-baby-blue mr-3">✓</span>
                                        <span className="text-medium-gray">Gentle, Evidence-Based Methods</span>
                                    </div>
                                </div>
                            </div>
                        </div>
