...
# Quick VPS Fix Script - Create and start working server
echo "🔧 Creating working server for VPS..."
...
# Create the working server directly
cat > baby-server.js << 'EOL'
...
echo "Starting the baby sleep application..."
pm2 start baby-server.js --name baby-sleep-app
pm2 save
...
echo "Your baby sleep website is now running at: http://31.97.99.104"
EOL