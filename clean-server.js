...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .service-card ul { text-align: left; color: #6b7280; margin-bottom: 24px; list-style: none; padding: 0; }
        .service-card li { margin-bottom: 8px; padding-left: 20px; position: relative; }
        .service-card li:before { content: "✓"; position: absolute; left: 0; color: #10b981; font-weight: bold; }
